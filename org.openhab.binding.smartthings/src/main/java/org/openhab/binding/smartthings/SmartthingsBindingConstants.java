...
public class SmartthingsBindingConstants {
    ...
    public final static Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = ImmutableSet.of(
            ...
            new ThingTypeUID(BINDING_ID, "garageDoorControl"), new ThingTypeUID(BINDING_ID, "illuminanceMeasurement"),
            ...
            new ThingTypeUID(BINDING_ID, "humiditySensor"), new ThingTypeUID(BINDING_ID, "relaySwitch"),
